...
## Executar no terminal
 ...
 # sem GUI
opp_run -u Cmdenv -n .:../../src/ -f mfcv.ini -r 0 -l ../../src/libveins.so
 # com GUI
opp_run -u Tkenv -n .:../../src/ -f mfcv.ini -r 0 -l ../../src/libveins.so

 #sem repeat
opp_run -u Cmdenv -n .:../../src/ -f mfcv.ini -l ../../src/libveins.so
opp_run -u Tkenv -n .:../../src/ -f mfcv.ini -l ../../src/libveins.so