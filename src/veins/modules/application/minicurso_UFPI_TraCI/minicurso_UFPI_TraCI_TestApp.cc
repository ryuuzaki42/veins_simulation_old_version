...
#include "veins/modules/application/minicurso_UFPI_TraCI/minicurso_UFPI_TraCI_TestApp.h"
#include "veins/modules/mobility/traci/TraCIColor.h"

using Veins::TraCIMobility;
using Veins::TraCIMobilityAccess;

using Veins::minicurso_UFPI_TraCI_TestApp;

Define_Module(Veins::minicurso_UFPI_TraCI_TestApp);

const simsignalwrap_t minicurso_UFPI_TraCI_TestApp::mobilityStateChangedSignal = simsignalwrap_t(MIXIM_SIGNAL_MOBILITY_CHANGE_NAME);

void minicurso_UFPI_TraCI_TestApp::initialize(int stage) {
...
void minicurso_UFPI_TraCI_TestApp::finish() {
}

void minicurso_UFPI_TraCI_TestApp::handleSelfMsg(cMessage *msg) {
}

void minicurso_UFPI_TraCI_TestApp::handleLowerMsg(cMessage* msg) {
    delete msg;
}
...
void minicurso_UFPI_TraCI_TestApp::handlePositionUpdate() {
