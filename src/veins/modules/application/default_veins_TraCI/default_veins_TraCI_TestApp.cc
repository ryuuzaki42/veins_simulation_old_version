...
#include "application/default_veins_TraCI/default_veins_TraCI_TestApp.h"
#include "mobility/traci/TraCIColor.h"

using Veins::TraCIMobility;
using Veins::TraCIMobilityAccess;

using Veins::default_veins_TraCI_TestApp;

Define_Module(Veins::default_veins_TraCI_TestApp);

const simsignalwrap_t default_veins_TraCI_TestApp::mobilityStateChangedSignal = simsignalwrap_t(MIXIM_SIGNAL_MOBILITY_CHANGE_NAME);

void default_veins_TraCI_TestApp::initialize(int stage) {
...
void default_veins_TraCI_TestApp::finish() {
}

void default_veins_TraCI_TestApp::handleSelfMsg(cMessage *msg) {
}

void default_veins_TraCI_TestApp::handleLowerMsg(cMessage* msg) {
    delete msg;
}
...
void default_veins_TraCI_TestApp::handlePositionUpdate() {
