...
void BaseWaveApplLayer::initialize_mfcv(int stage) {
    BaseApplLayer::initialize(stage);
...
void BaseWaveApplLayer::initialize_osdp(int stage) {
    BaseApplLayer::initialize(stage);
...
void BaseWaveApplLayer::initialize_service_discovery(int stage) {
    BaseApplLayer::initialize(stage);
...
void BaseWaveApplLayer::initialize_test1(int stage) {
    BaseApplLayer::initialize(stage);
